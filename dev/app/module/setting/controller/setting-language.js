define([
    ...
    return function($scope, $injector, $state, $http2, $modal, gettextCatalog) {
        ...
        $scope.fetchData = function() {
            ...
            $http2.post('setting/form_language').success($scope.fetchDataSuccess).error($scope.fetchDataError).
            finally(function() {
        ...
        $scope.fetchDataSuccess = function(data) {
            ...
            $scope.form = data;
            $scope.formData.language_id = $scope.form.language_id;
        ...
        $scope.onSave = function() {
            ...
            $http2.post('setting/update_language', $scope.formData).success($scope.saveSuccess).error($scope.saveError).
            finally(function() {
