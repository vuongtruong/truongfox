define([
    ...
    return function($scope, $injector, $state, $http2, $modal, gettextCatalog) {
        ...
        $scope.fetchData = function() {
            ...
            $http2.post('setting/form_privacy_items').success($scope.fetchDataSuccess).error($scope.fetchDataError).
            finally(function() {
        ...
        $scope.prepareFormData = function() {
            ...
            for (var i = 0; i < $scope.form.length; i++) {
                ...
                $scope.formData[setting.key] = setting.default;
            };
        };
        ...
        $scope.onSave = function() {
            ...
            $http2.post('setting/update_privacy_items', {privacy: $scope.formData}).success($scope.saveSuccess).error($scope.saveError).
            finally(function() {
