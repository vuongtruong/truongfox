define([
    ...
    return function($scope, $injector, $state, $http2, $modal, gettextCatalog) {
        ...
        $scope.fetchData = function() {
            ...
            $http2.post('setting/form_default_currency').success($scope.fetchDataSuccess).error($scope.fetchDataError).
            finally(function() {
        ...
        $scope.fetchDataSuccess = function(data) {
            ...
            $scope.form = data;
            $scope.formData.default_currency = $scope.form.default_currency;
        ...
        $scope.onSave = function() {
            ...
            $http2.post('setting/update_default_currency', $scope.formData).success($scope.saveSuccess).error($scope.saveError).
            finally(function() {
