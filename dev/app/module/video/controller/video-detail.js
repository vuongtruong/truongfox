            ...
            $http2.get('video/detail', sendData)
                .success(function(data){
                    if(data.error_code){
                        ...
                        if($scope.item.sEmbedCode){
                            var video_width = window.screen.width;
                            $scope.item.sEmbedCode = $scope.item.sEmbedCode.replace(/width="640"/, 'width="'+video_width+'"')
                            ...
                            $timeout(function() {
                                ...
                                $iframe_holder.html($scope.item.sEmbedCode);
