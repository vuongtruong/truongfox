define([
    ...
    return function($sce, $injector, $scope, $state, $http2, $modal, gettext, gettextCatalog, $ionicModal, $site, $location, $timeout, $coreSettings, $dislike) {
        ...
        $scope.videoItemOptions = ['watch_later', 'add_to_playlist', 'favorite', 'edit', 'delete'];
        ...
        $scope.loadInit = function(){
            $http2.get('ultimatevideo/detail', sendData)
                .success(function(data){
                    if(data.error_code){
                        ...
                        if($scope.item.sEmbed){
                            ...
                            $scope.item.sEmbed = $scope.item.sEmbed.replace(/src="\/\//, 'src="http://').replace(/width="640"/, 'width="'+video_width+'"')
