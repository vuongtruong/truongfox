define([
    ...
    return function($scope, $injector, $site) {
        $site.debug > 2 && console.log('UltimateVideoFavoriteVideoController');
        /**
        ...
        $scope.videoItemOptions = ['watch_later', 'add_to_playlist', 'favorite'];
        $scope.videoRemoveOptions = ['favorite'];
    };
});
