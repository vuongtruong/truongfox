define([
    ...
    return function($scope, $injector, $state, $http2, $site, $modal, gettext, gettextCatalog, $viewer, $location) {
        ...
        $scope.getForm = function() {
            ...
            $http2.get('page/topic_info', postData)
        ...
        $scope.getQuotedPost = function() {
            ...
            $http2.get('page/post_info', postData)
        ...
        $scope.save = function() {
            ...
            $http2.post('page/post_reply', $scope.formData)
        ...
        $scope.doSaveWithPhoto = function() {
        	...
        	$http2.upload('page/post_reply', $scope.formData.photoPath, $scope.formData).then(success, error);
        };
