define([
    ...
    return function($scope, $injector, $state, $http2, $site, $modal, gettext, gettextCatalog, $viewer, $location) {
        ...
        $scope.save = function() {
            ...
            $http2.post('page/create_topic', $scope.formData)
        ...
        $scope.doSaveWithPhoto = function() {
            ...
            $http2.upload('page/create_topic', $scope.formData.photoPath, $scope.formData).then(success, error);
        };
